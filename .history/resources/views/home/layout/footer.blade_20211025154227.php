            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        ...
                        method: 'POST',
                        data:{last_name:last_name, first_name:first_name,phone:phone, email:email,adress:adress,note:note, order_feeship:order_feeship, shipping_method:shipping_method, order_coupon:order_coupon,_token :_token },
                            success:function(){
                                Swal.fire(
                                    'Deleted!',
