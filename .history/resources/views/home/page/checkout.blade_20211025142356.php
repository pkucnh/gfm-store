                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-6">
                            ...
                            <div class="checkout__input">
                                ...
                                <input type="text" name="note" placeholder="Nội dung" style="height:100px">
                            </div>
                        </div>
                        ...
                        {{-- <li>Tiền sau khi giảm:<span>{{$total}}</span></li> --}}
                                ...
                                <button type="submit" name="send_order" class="site-btn check_out send_order">Đặt hàng</button>
