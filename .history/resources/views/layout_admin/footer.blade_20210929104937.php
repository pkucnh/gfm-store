...
<footer class="main-footer">
    <strong>Copyright &copy; 2014-2021 <a href="https://adminslte.io">adminsLTE.io</a>.</strong>
    All rights reserved.
...
<!-- adminsLTE App -->
<script src="{{asset('admins/dist/js/adminslte.js')}}"></script>
<!-- adminsLTE for demo purposes -->
<script src="{{asset('admins/dist/js/demo.js')}}"></script>
<!-- adminsLTE dashboard demo (This is only for demo purposes) -->
