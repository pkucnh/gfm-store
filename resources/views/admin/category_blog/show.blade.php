...
@section('title')
<title>GFM | category_blog-Admin</title>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form action="{{url('category_blog/destroy')}}" method="post" >
                            @csrf
                            @method('DELETE')
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="{{url('category_blog')}}/{{$row->id}}/edit" class="btn btn-warning">Cập nhật</a></td>   
                                        </tr>
                                        @endforeach
                                    </tbody>
                                    <tfoot>
