                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                                              ...
                                                              <div class="col-md-12">
                                                                  <div class="card">                                               
                                                                      <div class="card-body row">
                                                                        ...
                                                                        <img src="{{asset('admin/images/product')}}/{{$row->image}}" width="250px" height="150px">
                                                                        <ul class="list">
                                                                            <li><h5 style="font-weight: bold;"><span>Tên sản phẩm</span>: <b class="text-danger">{{$row->name}}</b></h5></li>
                                                                            <li><h5 style="font-weight: bold;"><span>Giá</span>: <b class="text-danger">{{number_format($row->price)}} VNĐ</b></h5></li>   
                                                                            <li><h5 style="font-weight: bold;"><span>Giá khuyến mãi</span>: <b class="text-danger">{{number_format($row->price_sales)}} VNĐ</b></h5></li>   
                                                                            <li><h5 style="font-weight: bold;"><span>Số lượng</span>: <b class="text-danger">{{$row->quanlity}}</b></h5></li>                                                                            
                                                                        </ul>
                                                                    </div>
                                                                  </div>
                                                              </div>
                                            ...
                                            <td><a href="{{url('product')}}/{{$row->id}}/edit" class="btn btn-warning">Cập nhật</a></td>
