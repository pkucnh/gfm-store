...
<div class="wrapper">
  ...
  <!-- <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="{{asset('admin/logo/logo.jpg')}}" alt="adminLTELogo" height="100" width="150">
  </div> -->
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="{{asset('admin/logo/logo.jpg')}}" alt="User Avatar" class="img-size-50 img-circle mr-3">
              <div class="media-body">
                <h3 class="dropdown-item-title">
                  John Pierce
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <!-- <a href="index3.html" class="brand-link">
      <img src="{{asset('admin/logo/logo.jpg')}}"  alt="adminLTE Logo" class="brand-image img-circle elevation-3" style="width: 40px; height: 50px">
      <span class="brand-text font-weight-light">GFM</span>
    </a> -->
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{asset('admin/images/avatar/'.Auth::user()->image)}}" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
          <a href="#" class="d-block">{{Auth::user()->fullname}}</a>
          <a href="{{url('admin/logout')}}" class="d-block"  onclick="return confirm('Bạn có chắc muốn thoát đăng nhập?')">Thoát</a>
        </div>
      </div>
      <!-- SidebarSearch Form -->
