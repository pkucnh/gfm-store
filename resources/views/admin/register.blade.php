...
<html lang="en">
<head>
    <base href="{{asset('public/layouts/backend')}}/">
                ...
                <div class="mdl-card__supporting-text color--dark-gray">
                    <div class="mdl-grid">
                        ...
                        <div class="mdl-cell mdl-cell--12-col mdl-cell--4-col-phone">
                            ...
                            @enderror
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-size">
                                <input class="mdl-textfield__input" value="{{old('email')}}" name="email" type="text" id="e-mail">
                            ...
                            @enderror
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-size">
                                <input class="mdl-textfield__input" name="re-password" type="password" id="password">
                        ...
                        <div class="mdl-cell mdl-cell--12-col mdl-cell--4-col-phone submit-cell">
                            <a href="{{asset('login')}}" class="login-link">I have already signed up</a>
