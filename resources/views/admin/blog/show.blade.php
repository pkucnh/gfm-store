            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form action="{{url('blog/destroy')}}" method="post" >
                            @csrf
                            @method('DELETE')
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$row->summary}}</td>
                                            <td width="200px">
                                                <img src="{{asset('admin/image/blog')}}/{{$row->image}}" width="150px" height="120px">
                                            </td>
                                            <td>{{$row->content}}</td>
                                            <td>{{$row->post_day}}</td>
                                            <td>{{$row->views}}</td>
                                            ...
                                            <td><a href="{{url('blog')}}/{{$row->id}}/edit" class="btn btn-warning">Cập nhật</a></td>   
                                        </tr>
                                        @endforeach
                                    </tbody>
                                    <tfoot>
